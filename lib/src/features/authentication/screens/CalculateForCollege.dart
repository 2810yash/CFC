...
class ClculateForCollege extends StatefulWidget {
  const ClculateForCollege({Key? key}) : super(key: key);

  @override
  State<ClculateForCollege> createState() => _ClculateForCollegeState();
}

class _ClculateForCollegeState extends State<ClculateForCollege> {
  double _total = 0.0;
  ...
  Widget build(BuildContext context) {
    Color textcolor = _total > 1000 ? Colors.red : Colors.green;
